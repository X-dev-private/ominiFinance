...
export default function Header() {
  ...
  return (
    <div className="flex flex-row items-center justify-between w-full h-20 bg-opacity-50 px-6 py-8 rounded-2xl">
      ...
      <div title="3" className="w-1/5 flex justify-end items-center">
          ...
          <div className="bg-white/90 p-8 rounded-2xl shadow-xl border border-white/20">
            ...
            <div className="flex flex-col gap-4">
              <button
                ...
                className="px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-blue-500/30">
                EVM
              </button>
              <button
                onClick={() => handleChainSelection('COSMOS')}
                className="px-8 py-4 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl hover:from-purple-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-purple-500/30">
                COSMOS
              </button>
            </div>
          </div>
