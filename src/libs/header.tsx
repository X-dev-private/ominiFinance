    ...
    return (
        <div className="flex flex-row items-center justify-between w-full h-16 bg-opacity-50 px-4 py-6 rounded-2xl">
            ...
            <div className="w-3/5 flex gap-3 items-center justify-center">
                ...
                <a href="/app/swap" className="px-4 py-1.5 text-sm bg-green-500 border border-green-500 text-white rounded-xl hover:bg-white hover:text-green-500 transition-all duration-300">
                    Swap
                </a>
                <a href="/app/swap" className="px-4 py-1.5 text-sm bg-green-500 border border-green-500 text-white rounded-xl hover:bg-white hover:text-green-500 transition-all duration-300">
                    Bridge
